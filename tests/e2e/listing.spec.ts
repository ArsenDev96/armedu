...
test("the writers listing filters within its own edition", async ({ page }) => {
  ...
  // All eight biographies are translated: six since July 2026, Grigor Narekatsi
  // since §81 and Daniel Varoujan since §84. Edited rather than derived on
  // purpose — this file's job is to notice when a section's published count
