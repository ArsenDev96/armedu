...
export const placeArticles: Article[] = [
  {
    ...
    keyFacts: [
      ...
      { label: "Գլխավոր եկեղեցին", value: "Սուրբ Աստվածածին, 1662 թ." },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Այսօր վայրում իշխող եկեղեցին Սուրբ Աստվածածինն է՝ կառուցված 1662 թվականին։ Դա հավաք, գմբեթավոր եկեղեցի է այն տեսակի, որը Քրիստինա Մարանչիի՝ հայ արվեստին նվիրված ակնարկը նկարագրում է այդ շրջանի համար. ամուր, պարզ շինված, զարդարանքը կենտրոնացած թմբուկի և մուտքի վրա, ոչ թե սփռված պատերով։",
    ...
    interestingFacts: [
      ...
      "Այսօր տեսանելի գրեթե ամեն ինչ ավանդությունից ուշ է ավելի քան հազարամյակով. գլխավոր եկեղեցին կառուցվել է 1662 թվականին։",
