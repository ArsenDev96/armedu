  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        heading: "2. Գրական ուղին",
        paragraphs: [
          "Սեւակը հրատարակեց իր առաջին ժողովածուն 1948 թվականին և ևս մի քանիսը՝ հաջորդ տասնամյակում, սակայն նրա հասուն ձայնն եկավ 1950-ականների վերջին։ Այնուհետև նա աշխատեց որպես գիտաշխատող, ապա որպես Երևանի Գրականության ինստիտուտի բարձրաստիճան գործիչ, իսկ 1966 թվականին ընտրվեց Հայաստանի գրողների միության քարտուղար։",
    ...
    keyFacts: [
      ...
      {
        label: "Նշանավոր երկեր",
        value: "«Անլռելի զանգակատուն», «Մարդն ափի մեջ», «Եղիցի լույս»",
      },
