...
export const workArticles: Article[] = [
  ...
  },
  {
    ...
    keyFacts: [
      ...
      { label: "Գլխավոր կերպարներ", value: "Աղասի, Թագուհի, նրա մայրը, պատմողը, Հուսեին խան և Հասան խան" }
    ],
    importantDates: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        heading: "Ստեղծագործության բովանդակությունը",
        paragraphs: [
          "Վարդանը երիտասարդ է, որը Հայկական լեռնաշխարհի գյուղերում շրջում է՝ առևտուր անելով և լուրեր փոխանցելով։ Նրա ուղիղ խոսքը, տեղական իշխանավորների առջև գլուխ չխոնարհելը և այն պնդումը, թե գյուղացիները կարող են պաշտպանել իրենք իրենց, նրան բերում են «Խենթ» մականունը։ Նա սիրահարվում է Լալային՝ Խաչո գյուղապետի դստերը, աղջկա, որին տղայի պես են մեծացրել Ստեփանիկ անունով, որպեսզի ո՛չ քուրդ Ֆաթահ բեկը, ո՛չ Թովմաս էֆենդի հարկահավաքը չիմանան, թե տանը ամուսնության տարիքի աղջիկ կա։ Նրանց հարաբերությունը դառնում է գրքի հուզական կենտրոնը։",
          ...
          "Երբ օսմանյան բանակը պաշարում է Բայազետը, Վարդանը կամավոր ստանձնում է թշնամու գծերով լուր հասցնել ռուս գեներալ Տեր-Ղուկասովին, և քաղաքի ազատագրումը կախված է լինում նրա հաջողությունից։ Լալան փախստականների շարասյան հետ անցնում է սահմանը՝ Վաղարշապատ, որտեղ հիվանդանում է և մահանում։ Վերջապես ազատ արձակված Վարդանը գտնում է միայն նրա գերեզմանը։ Վեպն ավարտվում է հենց այնտեղ՝ ապագա Հայաստանի մասին նրա տեսիլքով՝ ազատ, ընտրովի խորհրդարանով, կանանց հավասար իրավունքներով և իր քաղաքների կրկին հայկական անուններով. ավարտ, որն այդ ժամանակից ի վեր ընթերցվում է կա՛մ որպես մարգարեություն, կա՛մ որպես բաղձանք։"
        ]
      },
      {
        id: "main-characters",
    ...
    keyFacts: [
      ...
      { label: "Առաջին հրատարակությունը", value: "Շարունակաբար՝ Թիֆլիսի «Մշակում» 1880 թվականին, առաջին առանձին հրատարակությունը՝ Շուշի, 1881" },
