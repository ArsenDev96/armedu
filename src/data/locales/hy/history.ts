...
export const categories: Category[] = [
  ...
  },
  {
    ...
    title: "Հայ գրողներ",
    description:
      "Ծանոթացեք Հայաստանի ամենաազդեցիկ գրողների կյանքին ու ստեղծագործությանը և տեսեք, թե ինչպես նրանց գրքերը ձևավորեցին այն լեզուն, որով այսօր կարդում ենք։",
    href: "/writers",
  ...
  },
  {
    ...
    title: "Գրական երկեր",
    description:
      "Այն երկերը, որոնց հայ աշակերտը հանդիպում է ամեն դասարանում՝ ամփոփումներով, պատմական համատեքստով, կերպարների բնութագրերով և հիմնական գաղափարներով։",
    href: "/works",
  ...
  },
  {
    ...
    description:
      "Ծանոթացեք հայկական ուտեստներին, որոնք պատմության, ընտանեկան կյանքի, տոների և սփյուռքի ավանդույթների մասն են՝ լավաշից ու տոլմայից մինչև հարիսա և ղափամա։",
    href: "/cuisine",
  ...
  },
  {
    ...
    title: "Վայրեր",
    description:
      "Հայաստանի վանքերը, ամրոցները, թանգարաններն ու բնությունը՝ որպես պատմություն, ոչ թե զբոսաշրջային երթուղի։ Սկսում ենք Արարատի ստորոտի Խոր Վիրապից։",
    href: "/places",
...
export const timeline: TimelineEntry[] = [
  {
    ...
    description:
      "Վանա լճի շուրջ ձևավորված հզոր պետությունը կառուցում է ամրոց-քաղաքներ, այդ թվում՝ Երևանի նախնի Էրեբունին։ Դրանցով սկսվում է Հայկական լեռնաշխարհի գրավոր պատմությունը։",
  },
  {
    id: "artaxiad",
  ...
  },
  {
    ...
    description:
      "Տրդատ Գ արքան քրիստոնեությունն ընդունում է որպես հայոց պետական կրոն։ Այդ որոշումը վերափոխեց հայ արվեստը, ճարտարապետությունն ու ինքնությունը։",
  },
  {
    id: "avarayr",
    period: "451 թ.",
    ...
    description:
      "Վարդան Մամիկոնյանը հայկական ուժերը գլխավորում է Սասանյան բանակի դեմ՝ պաշտպանելով հավատի ազատությունը։ Ռազմական պարտությունը դարձավ քաղաքական հաղթանակ։",
  },
  {
    id: "bagratid",
    period: "885–1045 թթ.",
    ...
    description:
      "Վերականգնված թագավորությունը ծաղկում է մայրաքաղաք Անիի շուրջ։ Հազար ու մի եկեղեցիների այս քաղաքն իր ժամանակի խոշորագույն քաղաքներից էր։",
  },
  {
    id: "first-republic",
    period: "1918–1920",
    ...
    description:
      "Դարեր շարունակ պետականությունից զուրկ մնալուց հետո հռչակվում է անկախ հայկական հանրապետություն։ Այն կարճ կյանք ունեցավ, բայց այսօրվա հանրապետության անմիջական նախորդն է։",
  },
];
