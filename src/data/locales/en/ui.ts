...
export const ui: UiDictionary = {
  ...
  footer: {
    ...
    christianity: "Adoption of Christianity",
    armenianAlphabet: "The Armenian Alphabet",
  ...
  listing: {
    ...
    history: {
      ...
      periodFilterHeading: "Period",
      topicTypeFilterHeading: "Topic type",
