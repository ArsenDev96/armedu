...
export const categories: Category[] = [
  ...
  },
  {
    ...
    title: "Հայ գրողներ",
    description:
      "Սորվեցէ՛ք Հայաստանի ամէնէն ազդեցիկ գրողներուն կեանքին ու գործերուն մասին, եւ թէ անոնց գիրքերը ինչպէ՛ս կերտեցին այն լեզուն՝ որ այսօր կը կարդանք։",
    href: "/writers",
...
export const timeline: TimelineEntry[] = [
  ...
  },
  {
    ...
    description:
      "Տրդատ Գ. թագաւորը կ՚ընդունի քրիստոնէութիւնը որպէս հայոց պետութեան կրօնը՝ որոշում մը որ նոր դիմագիծ կու տայ հայ արուեստին, ճարտարապետութեան եւ ինքնութեան։",
  },
  {
    id: "avarayr",
    period: "Ք.Ե. 451",
  ...
  },
  {
    ...
    description:
      "Վերականգնուած թագաւորութիւն մը կը ծաղկի իր մայրաքաղաքին՝ Անիի շուրջ, հազար ու մէկ եկեղեցիներու քաղաքը եւ իր դարուն ամէնէն մեծ քաղաքներէն մէկը։",
  },
  {
    id: "first-republic",
    period: "1918–1920",
