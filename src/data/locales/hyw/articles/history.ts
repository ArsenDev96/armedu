...
export const historyArticles: Article[] = [
  {
    ...
    interestingFacts: [
      ...
      "Պղուտարքոս կ՚արձանագրէ, թէ երբ Տիգրան առաջին անգամ տեսաւ մօտեցող հռոմէական ուժին փոքրութիւնը, զայն արհամարհեց խօսքով մը, որ անկէ ի վեր կը հետեւի իրեն. եթէ իբրեւ դեսպաններ եկած են՝ շատ են, իսկ եթէ իբրեւ զինուորներ՝ խիստ քիչ։ Յաջորդող ճակատամարտը շահեցան հռոմէացիները։",
