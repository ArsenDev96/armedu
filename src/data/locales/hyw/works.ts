...
export const works: LiteraryWork[] = [
  ...
  },
  {
    ...
    genreId: "drama",
    summary:
      "Բարեկեցիկ պոլսահայ վաճառական մը իր կինը կը բռնէ սիրահարին հետ եւ գործը կը հասցնէ համայնքին սեփական դատարանին, որ կը վճռէ թէ տեսածը պարզապէս տեսողական խաբկանք մըն էր։ Պարոնեանի միակ թատերգութիւնը, գրուած՝ 1886-ին եւ բեմադրուած՝ իր մահէն ետք, 1895-ին։",
  ...
  },
  {
    ...
    genreId: "novel",
    summary:
      "Երգիծական, ինքնագիտակցաբար արդիական «պոեմանման վէպ» մը՝ Կարսի, Չարենցի ծննդավայրին, վերջին տարիներուն մասին, պատմուած պատմող մը՝ որ ինք կը հայտարարէ թէ քաղաքին մէջ հերոս մը չկար։ Գրուած՝ 1921–1925, հրատարակուած՝ 1926-ին. յաճախ կը կոչուի առաջին հայ արդիապաշտ վէպը։",
