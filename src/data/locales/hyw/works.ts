...
export const works: LiteraryWork[] = [
  ...
  },
  {
    ...
    genreId: "epic",
    summary:
      "Հայոց ազգային դիւցազնավէպը, որ կը պատմէ սասունցի դիւցազուններու չորս սերունդներուն մասին՝ որոնք կը պաշտպանեն իրենց լեռնային հայրենիքը. հազար տարի զրուցագիրներու բերնով փոխանցուած՝ նախքան գրի առնուիլը։",
